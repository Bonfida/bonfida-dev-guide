...
Same goes for the `repr(C)` attribute which is essential for type casting.
...
As a nice bonus, if you later want to add a new field to the object, you'll be able to do so while maintaining backwards compatibility!
